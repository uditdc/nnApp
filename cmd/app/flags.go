...
func parseFlags() config.Config {
	...
	pflag.StringVar(&cfg.API, "rest-api", defaultAPIPort, "address where the web server will listen on")
	...
	pflag.UintVar(&cfg.Host.WebsocketPort, "websocket-port", defaultWsPort, "port to use for websocket connections")
